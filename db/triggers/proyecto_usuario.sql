CREATE OR REPLACE FUNCTION do_bitacora_proyecto_usuario()
RETURNS TRIGGER 
AS
$BODY$
DECLARE
...
BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
        value := CONCAT_WS('|', NEW.proyecto, NEW.usuario, NEW.activo); 
    ...
    IF TG_OP = 'DELETE' THEN
        value := CONCAT_WS('|', OLD.proyecto, OLD.usuario, OLD.activo); 
...
CREATE TRIGGER do_bitacora_proyecto_usuario
AFTER INSERT OR UPDATE OR DELETE
ON proyecto_usuario
FOR EACH ROW
EXECUTE PROCEDURE do_bitacora_proyecto_usuario();
