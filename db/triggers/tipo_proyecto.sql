CREATE OR REPLACE FUNCTION do_bitacora_tipo_proyecto()
RETURNS TRIGGER 
AS
$BODY$
DECLARE
...
BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
        value := CONCAT_WS('|', NEW.tipo_proyecto_id, NEW.tipo_proyecto); 
    ...
    IF TG_OP = 'DELETE' THEN
        value := CONCAT_WS('|', OLD.tipo_proyecto_id, OLD.tipo_proyecto); 
...
CREATE TRIGGER do_bitacora_tipo_proyecto
AFTER INSERT OR UPDATE OR DELETE
ON tipo_proyecto
FOR EACH ROW
EXECUTE PROCEDURE do_bitacora_tipo_proyecto();
