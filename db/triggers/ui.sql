CREATE OR REPLACE FUNCTION do_bitacora_ui()
RETURNS TRIGGER 
AS
$BODY$
DECLARE
...
BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
        value := CONCAT_WS('|', NEW.ui_id, NEW.descripcion); 
    ...
    IF TG_OP = 'DELETE' THEN
        value := CONCAT_WS('|', OLD.ui_id, OLD.descripcion); 
...
CREATE TRIGGER do_bitacora_ui
AFTER INSERT OR UPDATE OR DELETE
ON ui
FOR EACH ROW
EXECUTE PROCEDURE do_bitacora_ui();
