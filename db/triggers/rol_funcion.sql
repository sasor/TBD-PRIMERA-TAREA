CREATE OR REPLACE FUNCTION do_bitacora_rol_funcion()
RETURNS TRIGGER 
AS
$BODY$
DECLARE
...
BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
        value := CONCAT_WS('|', NEW.rol, NEW.funcion, NEW.active); 
    ...
    IF TG_OP = 'DELETE' THEN
        value := CONCAT_WS('|', OLD.rol, OLD.funcion, OLD.active); 
...
CREATE TRIGGER do_bitacora_rol_funcion
AFTER INSERT OR UPDATE OR DELETE
ON rol_funcion
FOR EACH ROW
EXECUTE PROCEDURE do_bitacora_rol_funcion();
