CREATE OR REPLACE FUNCTION do_bitacora_funcion()
RETURNS TRIGGER 
AS
$BODY$
DECLARE
...
BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
        value := CONCAT_WS('|', NEW.funcion_id, NEW.descripcion); 
    ...
    IF TG_OP = 'DELETE' THEN
        value := CONCAT_WS('|', OLD.funcion_id, OLD.descripcion); 
...
CREATE TRIGGER do_bitacora_funcion
AFTER INSERT OR UPDATE OR DELETE
ON funcion
FOR EACH ROW
EXECUTE PROCEDURE do_bitacora_funcion();
