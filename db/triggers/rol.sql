CREATE OR REPLACE FUNCTION do_bitacora_rol()
RETURNS TRIGGER 
AS
$BODY$
DECLARE
...
BEGIN
    ...
    IF TG_OP = 'INSERT' THEN
        value := CONCAT_WS('|', NEW.rol_id, NEW.descripcion); 
    ...
    IF TG_OP = 'DELETE' THEN
        value := CONCAT_WS('|', OLD.rol_id, OLD.descripcion); 
...
CREATE TRIGGER do_bitacora_rol
AFTER INSERT OR UPDATE OR DELETE
ON rol
FOR EACH ROW
EXECUTE PROCEDURE do_bitacora_rol();
